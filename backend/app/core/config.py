...
class Settings(BaseSettings):
    ...
    # Inbound images are inlined to the vision model as base64 data URIs (WAHA's
    # media URL is on an internal host the provider can't fetch). Skip anything
    # larger than this to bound the request payload / token blowup.
    max_inbound_image_bytes: int = 5_000_000
